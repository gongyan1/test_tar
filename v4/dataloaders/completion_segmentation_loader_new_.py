...
def get_paths_and_transform(split, args):
    ...
    if split == "train":
        ...
        glob_lane_label = os.path.join(
            args.data_folder,
            #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
            'small_data/lane_label/*.png'
        )
        
        # 4、
        glob_rgb = os.path.join(
                args.data_folder,
                'small_data/train_image_2_lane/*.png'
            )
...
#                            ps[-2:-1] + ['data'] + ps[-1:])
        ...
        if args.val == "select":
            ...
            glob_pc = os.path.join(
                args.data_folder,
                #'data_depth_velodyne/train/*_sync/proj_depth/velodyne_raw/image_0[2,3]/*.png'
                'small_data/aug_test/knn_pc/*.png'
            )
            ...
            glob_road_label = os.path.join(
                args.data_folder,
                #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
                'small_data/aug_test/road_label/*.png'
            )
            ...
            glob_lane_label = os.path.join(
                args.data_folder,
                #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
                'small_data/aug_test/lane_label/*.png'
            )
            
            # 4、
            glob_rgb = os.path.join(
                    args.data_folder,
                    'small_data/aug_test/train_image_2_lane/*.png'
                )       
